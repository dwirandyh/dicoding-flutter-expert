...
void main() {
  ...
  testWidgets('should showing data correctly with poster', (widgetTester) async {
    final item = ItemData(
        title: "title",
        overview: "overview",
  ...
  testWidgets('should showing data correctly with error placeholder icon', (widgetTester) async {
    final item = ItemData(
        title: "title",
        overview: "overview",
        posterPath: null
  ...
  testWidgets('should trigger tap event', (widgetTester) async {
    ...
    await widgetTester.pumpWidget(_makeTestableWidget(ItemCard(item: item, onTap: onTap)));
