...
class TvDetailModel {
  ...
  factory TvDetailModel.fromJson(Map<String, dynamic> json) => TvDetailModel(
    ...
    networks: List<TvCompanyNetworkModel>.from(json["networks"].map((x) => TvCompanyNetworkModel.fromJson(x))),
    ...
    productionCompanies: List<TvCompanyNetworkModel>.from(json["production_companies"].map((x) => TvCompanyNetworkModel.fromJson(x))),
...
class TvSeasonModel {
  ...
  factory TvSeasonModel.fromRawJson(String str) => TvSeasonModel.fromJson(json.decode(str));
