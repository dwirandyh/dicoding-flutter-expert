...
import 'package:tv/data/models/tv/tv_company_network_model.dart';
import 'package:tv/data/models/tv/tv_created_by_model.dart';
import 'package:tv/data/models/tv/tv_detail_model.dart';
import 'package:tv/data/models/tv/tv_model.dart';
import 'package:tv/data/models/tv/tv_production_country_model.dart';
import 'package:tv/data/models/tv/tv_spoken_language_model.dart';
  ...
  group('Now Playing TV', () {
    test(
      ...
      when(mockRemoteDataSource.getNowPlayingTv())
          .thenAnswer((_) async => testTvModels);
      // act
    ...
    test('should return server error when the call to remote server failed',
        () async {
      // arrange
